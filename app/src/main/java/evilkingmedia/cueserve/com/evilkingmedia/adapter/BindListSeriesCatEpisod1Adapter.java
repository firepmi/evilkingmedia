...
public class BindListSeriesCatEpisod1Adapter extends RecyclerView.Adapter<BindListSeriesCatEpisod1Adapter.myview> implements Filterable {
    ...
    public BindListSeriesCatEpisod1Adapter(List<MoviesModel> moviesList, Context context) {
    ...
    @NonNull
    @Override
    public BindListSeriesCatEpisod1Adapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BindListSeriesCatEpisod1Adapter.myview holder, final int position) {
