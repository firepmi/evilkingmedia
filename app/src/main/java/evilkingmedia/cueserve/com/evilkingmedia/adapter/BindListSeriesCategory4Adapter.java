...
public class BindListSeriesCategory4Adapter extends RecyclerView.Adapter<BindListSeriesCategory4Adapter.myview> {
    ...
    public BindListSeriesCategory4Adapter(List<MoviesModel> moviesList, Context context) {
    ...
    @NonNull
    @Override
    public BindListSeriesCategory4Adapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BindListSeriesCategory4Adapter.myview holder, final int position) {
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(context, SeriesActivityServer4.class);
